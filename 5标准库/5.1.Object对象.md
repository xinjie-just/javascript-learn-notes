...
(function fn() { return Object.prototype.toString.call(arguments); })() // arguments 对象， '[object Arguments]'

Object.prototype.toString.call(function(){}) // 函数， '[object Function]'

Object.prototype.toString.call(new Error('error')) // Error 对象， '[object Error]'

Object.prototype.toString.call(new Date()) // Date 对象， '[object Date]'

Object.prototype.toString.call(/^[a-zA-Z1-9]{4,6}$/) // RegExp 对象， '[object RegExp]'
