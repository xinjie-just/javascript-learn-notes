...
let a = ["x", "y"];
Object.keys(a);                // (2) ["0", "1"]
Object.getOwnPropertyNames(a); // (3) ["0", "1", "length"]
```
...
Object.prototype.toString.call(new Error("error")); // "[object Error]"
Object.prototype.toString.call(new Date());         // "[object Date]"
Object.prototype.toString.call(/^[a-zA-Z]{4,6}$/);  // "[object RegExp]"
Object.prototype.toString.call({});                 // "[object Object]"
(function f() { return Object.prototype.toString.call(arguments); })() // "[object Arguments]"
```
